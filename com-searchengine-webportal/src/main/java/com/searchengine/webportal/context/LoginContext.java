package com.searchengine.webportal.context;
...
public class LoginContext {
    ...
    public LoginContext(long userId, String loginName, String nickName, int roleType) {
        this.userId = userId;
        this.loginName = loginName;
        this.nickName = nickName;
     ...
     * 反向构造上下文。
     *
     * @param value 需要反向构造的串。形式如下：userId=123,loginName=yxtest001,nickName=昵称
     * @return 上下文
     * @see #toCookieValue()
     */
