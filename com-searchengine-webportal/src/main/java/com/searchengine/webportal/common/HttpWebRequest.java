...
public class HttpWebRequest {
    ...
    // 最大连接时间：毫秒
    private static final int CONNECTION_TIMEOUT = 40 * 1000;//default:10*1000
    // socket最大连接时间：毫秒
    private static final int SO_TIMEOUT = 40 * 1000;//default:10*1000
     ...
     * @return
     */
    public static byte[] getByte(String url, Map<String, String> paramMap) throws Exception {
        byte[] result = requestByte(HttpWebRequestMethod.Get, url, paramMap, null, null);
        return result;
    }
    ...
    public static byte[] requestByte(String method, String url, Map<String, String> paramMap, String httpEntityData, String
            contentType) throws Exception {
